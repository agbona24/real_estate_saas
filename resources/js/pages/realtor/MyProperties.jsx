            ...
            <VStack p={5} align="start" spacing={3}>
                ...
                <VStack align="start" spacing={1} w="100%">
                    <HStack justify="space-between" w="100%" fontSize="sm">
                        ...
                        <Text fontWeight="semibold">{property.views}</Text>
                    </HStack>
                    <HStack justify="space-between" w="100%" fontSize="sm">
                        <Text color="gray.500">Inquiries:</Text>
                        <Text fontWeight="semibold">{property.inquiries}</Text>
                    </HStack>
                </VStack>
...
const MyProperties = () => {
    const properties = [
        ...
        },
        {
            ...
            title: 'Cozy Cottage',
            price: 285000,
            location: '147 Grove St, Suburban',
            type: 'House',
            bedrooms: 2,
            bathrooms: 1,
            sqft: 1100,
