...
<head>
    ...
    <title>Agency Dashboard - RealEstate Pro</title>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-lg p-8 text-white mb-8">
                <h2 class="text-3xl font-bold mb-2">
                    <i class="fas fa-building mr-2"></i> Welcome, {{ auth()->user()->name }}!
                </h2>
                <p class="text-indigo-100">Agency Admin Dashboard</p>
            </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2">$48.5K</p>
                            <p class="text-sm text-purple-600 mt-1">
                                <i class="fas fa-chart-line"></i> +15% vs last month
                            </p>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <button class="flex items-center justify-center space-x-2 bg-orange-50 hover:bg-orange-100 text-orange-700 px-6 py-4 rounded-lg transition-colors">
