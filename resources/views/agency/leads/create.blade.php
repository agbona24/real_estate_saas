...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('agency.leads.store') }}" method="POST">
            @csrf
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center rounded-b-lg">
                <a href="{{ route('agency.leads.index') }}" class="text-gray-600 hover:text-gray-800 flex items-center">
                    <i class="fas fa-arrow-left mr-2"></i>
                    Back to Leads
                </a>
                <div class="flex space-x-3">
                    <button type="button" onclick="window.location.href='{{ route('agency.leads.index') }}'"
