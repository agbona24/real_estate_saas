...
<div class="max-w-6xl mx-auto">
    ...
    <form action="{{ route('agency.properties.store') }}" method="POST" enctype="multipart/form-data" x-data="{ type: 'sale', category: '' }">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow px-6 py-4 flex justify-between items-center">
            <a href="{{ route('agency.properties.index') }}" class="text-gray-600 hover:text-gray-800 flex items-center">
                <i class="fas fa-arrow-left mr-2"></i>
                Back to Properties
            </a>
            <div class="flex space-x-3">
                <button type="button" onclick="window.location.href='{{ route('agency.properties.index') }}'"
