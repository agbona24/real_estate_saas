...
@section('navigation')
    ...
    <a href="{{ route('agency.reports.index') }}" class="flex items-center rounded-lg transition-colors bg-primary-50 text-primary-700" :class="sidebarCollapsed ? 'justify-center p-3' : 'space-x-3 px-3 py-2.5'">
