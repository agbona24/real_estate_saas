...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex space-x-3">
            ...
            <button onclick="window.location.href='{{ route('tenant.clients.edit', $client->id ?? 1) }}'" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md">
                    ...
                    @forelse($client->properties ?? [] as $property)
                        <div class="p-4 hover:bg-gray-50">
                            <div class="flex items-center space-x-4">
                                ...
                                <button onclick="window.location.href='{{ route('tenant.properties.show', $property->id ?? 1) }}'" class="text-indigo-600 hover:text-indigo-700">
                            ...
                            @forelse($client->transactions ?? [] as $transaction)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <button onclick="window.location.href='{{ route('tenant.transactions.show', $transaction->id ?? 1) }}'" class="text-indigo-600 hover:text-indigo-700">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-2">
                    ...
                    <button onclick="window.location.href='{{ route('tenant.clients.documents', $client->id ?? 1) }}'" class="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-md text-sm">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="px-6 py-3 border-t border-gray-200">
                    <button onclick="window.location.href='{{ route('tenant.clients.documents', $client->id ?? 1) }}'" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
