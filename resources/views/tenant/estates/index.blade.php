...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <button onclick="window.location.href='{{ route('tenant.estates.create') }}'" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($estates ?? [] as $estate)
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition cursor-pointer" onclick="window.location.href='{{ route('tenant.estates.show', $estate->id ?? 1) }}'">
                <!-- Estate Image -->
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="event.stopPropagation(); window.location.href='{{ route('tenant.estates.plots', $estate->id ?? 1) }}'" class="bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded text-sm font-medium">
                            <i class="fas fa-th mr-1"></i> View Plots
                        </button>
                        <button onclick="event.stopPropagation(); window.location.href='{{ route('tenant.estates.allocate', $estate->id ?? 1) }}'" class="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded text-sm font-medium">
        ...
        @empty
            <div class="col-span-3 bg-white rounded-lg shadow p-12 text-center">
                ...
                <button onclick="window.location.href='{{ route('tenant.estates.create') }}'" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-md font-semibold">
