...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <button onclick="window.location.href='{{ route('tenant.properties.create') }}'" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition group">
                ...
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <button onclick="window.location.href='{{ route('tenant.properties.show', $property->id ?? 1) }}'"
                                class="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md text-sm font-medium">
                            <i class="fas fa-eye mr-1"></i> View
                        </button>
                        <button onclick="window.location.href='{{ route('tenant.properties.edit', $property->id ?? 1) }}'"
        ...
        @empty
            <div class="col-span-full text-center py-12 bg-white rounded-lg shadow">
                ...
                <button onclick="window.location.href='{{ route('tenant.properties.create') }}'" class="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-md">
