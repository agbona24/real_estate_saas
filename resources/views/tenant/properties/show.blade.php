...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex space-x-3">
            ...
            <button onclick="window.location.href='{{ route('tenant.properties.edit', $property->id ?? 1) }}'" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md">
