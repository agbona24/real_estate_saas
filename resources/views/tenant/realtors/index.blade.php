...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <button onclick="window.location.href='{{ route('tenant.realtors.create') }}'" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($realtors ?? [] as $realtor)
            <div class="bg-white rounded-lg shadow hover:shadow-xl transition">
                ...
                <div class="pt-14 pb-6 px-6 text-center">
                    ...
                    <p class="text-sm text-gray-500 mb-1">{{ $realtor->email ?? 'john@tenant.com' }}</p>
                ...
                <div class="border-t border-gray-200 px-6 py-3 bg-gray-50 rounded-b-lg">
                    <div class="flex justify-between items-center">
                        <button onclick="window.location.href='{{ route('tenant.realtors.show', $realtor->id ?? 1) }}'"
        ...
        @empty
            <div class="col-span-3 text-center py-12 bg-white rounded-lg shadow">
                ...
                <button onclick="window.location.href='{{ route('tenant.realtors.create') }}'" class="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-md">
