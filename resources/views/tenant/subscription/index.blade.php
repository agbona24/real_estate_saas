...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-xl p-8 text-white">
        <div class="flex justify-between items-start">
            ...
            <div>
                <button onclick="window.location.href='{{ route('tenant.subscription.plans') }}'" class="bg-white text-indigo-600 hover:bg-indigo-50 px-6 py-3 rounded-lg font-semibold shadow-lg">
    ...
    <div class="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-6">
        <div class="flex items-start justify-between">
            <div>
                ...
                <button onclick="window.location.href='{{ route('tenant.subscription.plans') }}'" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-medium">
                    View All Plans
                </button>
            </div>
