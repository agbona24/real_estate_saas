            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" value="info@tenant.com" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm">
                    </div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea rows="3" placeholder="Describe your tenant..." class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm"></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Keywords
